...
if 'ds1_p_chart' not in st.session_state.visualizations:
    ...
    st.session_state.visualizations['ds1_p_chart'], st.session_state.visualizations['ds1_count_chart']= ds1_p, ds1_count
...
if 'ds2_p_chart' not in st.session_state.visualizations:
    ...
    st.session_state.visualizations['ds2_p_chart'],st.session_state.visualizations['ds2_count_chart'] = ds2_p, ds2_count
    pre_button = False
...
if 'val_accuracy_chart' in st.session_state.visualizations:
    ...
    for label in st.session_state.visualizations['metrics_df_chart']['Label']:
        data_frame = st.session_state.visualizations['metrics_df_chart'][metriche].loc[st.session_state.visualizations['metrics_df_chart']['Label'] == label]
    ...
    for label in st.session_state.visualizations['metrics_df_label_chart']['Label']:
        data_frame_label = st.session_state.visualizations['metrics_df_label_chart'][metriche].loc[st.session_state.visualizations['metrics_df_label_chart']['Label'] == label]
        text = np.trunc(data_frame.values * 1000) / 1000
